...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/platforms/genlogin/profiles": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "description": "Get profiles from Genlogin platform",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/api/v1/platforms/hidemium/profiles": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "description": "Get profiles from Hidemium platform",
                "consumes": [
                    "application/json"
                ],
                "produces": [
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/config.PlatformRoutes"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/api/v1/platforms/{platform}/endpoints/{endpoint}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Platform name (hidemium, genlogin)",
                        "name": "platform",
                        "in": "path",
                        "required": true
                    },
        ...
        "/api/v1/platforms/{platform}/endpoints/{endpoint}/url": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "config.GenloginRoutes": {
            ...
            "properties": {
                ...
                "endpoints": {
                    "type": "object",
                    "additionalProperties": {
                        "$ref": "#/definitions/config.GenloginEndpoint"
                    }
                }
            }
        },
        "config.HidemiumEndpoint": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "config.HidemiumRoutes": {
            ...
            "properties": {
                ...
                "endpoints": {
                    "type": "object",
                    "additionalProperties": {
                        "$ref": "#/definitions/config.HidemiumEndpoint"
                    }
                }
            }
        },
        "config.PlatformRoutes": {
            "type": "object",
            "properties": {
                "genlogin": {
                    "$ref": "#/definitions/config.GenloginRoutes"
                },
                "hidemium": {
                    "$ref": "#/definitions/config.HidemiumRoutes"
                }
            }
        },
        "models.App": {
